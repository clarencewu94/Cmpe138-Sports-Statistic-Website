...
c.execute("INSERT INTO user Values ('JimboJones', 'waffles', 2)")
c.execute("INSERT INTO user Values ('Kearny', 'toast', 3)")
c.execute("INSERT INTO user Values ('NelsonMuntz', 'bacon', 4)")
c.execute("INSERT INTO user Values ('KRUSTYtheCLOWN', 'ScrambledEggs', 5)")
...
c.execute("INSERT INTO golf Values('KRUSTYtheCLOWN', 2, 'Kahuna Golf', 2, 2, 3, 0, 1, 0, -1, 4, 0)")
...
c.execute("INSERT INTO golf Values('KRUSTYtheCLOWN', 5, 'Kahuna Golf', 3, 2, -1, 2, 2, 2, 3, 2, 1)")
...
c.execute("INSERT INTO golf Values('KRUSTYtheCLOWN', 9, 'Kahuna Golf', 5, 2, 6, 2, 2, 2, 1, 2, -2)")
